...
import { Frequency, immediate, Sampler } from 'tone';
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return Promise.all(tuning.map(function (midi) {
                return new Promise(function (resolve) {
                  var synth = new Sampler(closest(midi, samples), function () {
            ...
            case 2:
              ...
              return _context.abrupt("return", {
                play: function play(string, fret, when) {
                  ...
                  synths[string].triggerAttackRelease(Frequency(tuning[string] + fret, 'midi').toFrequency(), 4, immediate() + when);
                },
                dispose: function dispose() {
...
function useSound(props) {
  ...
  var _useState2 = useState(tuning.map(function () {
    return false;
  })),
  ...
  var play = useCallback(function (string, when) {
  ...
  var strum = useCallback(function (up) {
...
//# sourceMappingURL=react-guitar-sound.esm.js.map
