...
var toString = function toString(tuning, options) {
  return tuning.map(function (midi) {
    var _options$pad;
...
var parse = function parse(string) {
  return string.split(' ').map(function (name) {
    ...
    return (_get$midi = get(name).midi) != null ? _get$midi : ((_get$chroma = get(name).chroma) != null ? _get$chroma : 0) + 12 * 3;
  }).reverse();
};
...
export { parse, standard, toString };
//# sourceMappingURL=react-guitar-tunings.esm.js.map
