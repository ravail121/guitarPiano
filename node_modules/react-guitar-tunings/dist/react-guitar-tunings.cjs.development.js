...
var toString = function toString(tuning, options) {
  return tuning.map(function (midi$1) {
    var _options$pad;

    return midi.midiToNoteName(midi$1, {
      pitchClass: true,
      sharps: true
    }).padEnd((_options$pad = options == null ? void 0 : options.pad) != null ? _options$pad : 0, ' ');
  }).reverse().join(' ');
};
var parse = function parse(string) {
  return string.split(' ').map(function (name) {
    ...
    return (_get$midi = note.get(name).midi) != null ? _get$midi : ((_get$chroma = note.get(name).chroma) != null ? _get$chroma : 0) + 12 * 3;
  }).reverse();
};
var tunings = /*#__PURE__*/[{
  instrument: 'guitar',
  name: 'Standard',
  ...
  return _extends({}, tuning, {
    notes: parse(tuning.notes)
  });
});
var standard = tunings[0].notes;

exports.default = tunings;
exports.parse = parse;
exports.standard = standard;
exports.toString = toString;
//# sourceMappingURL=react-guitar-tunings.cjs.development.js.map
